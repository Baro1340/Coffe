...
public class ManageCategory extends javax.swing.JFrame {
    ...
    public void validateField(){
        String sanPhamMoi = txtLoaiHinhMoi.getText();
        if(!sanPhamMoi.equals("")){
    ...
    private void initComponents() {
        ...
        txtLoaiHinhMoi = new javax.swing.JTextField();
        ...
        jLabel2.setText("Loại Hình ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 60, -1, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(472, 97, 320, 360));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("*Bấm vào dòng muốn xóa Loại Hình để xóa");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 470, -1, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Thêm Loại");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 140, -1, -1));

        txtLoaiHinhMoi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtLoaiHinhMoiKeyReleased(evt);
            }
        });
        getContentPane().add(txtLoaiHinhMoi, new org.netbeans.lib.awtextra.AbsoluteConstraints(125, 172, 266, 30));
        ...
        getContentPane().add(btnLuu, new org.netbeans.lib.awtextra.AbsoluteConstraints(125, 220, -1, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 220, -1, -1));

        jLabel5.setText("jLabel5");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 930, 650));
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        category.setTenLoaiHinh(txtLoaiHinhMoi.getText());
        int kq = CategoryDAO.getInstance().insert(category);
        setVisible(false);
        new ManageCategory().setVisible(true);
        if(kq>0){
            JLabel label = new JLabel("Lưu Sản Phẩm Thành Công!");
        label.setFont(new Font("Arial", Font.BOLD, 14));
            JOptionPane.showMessageDialog(null, label,"MESSAGE",JOptionPane.INFORMATION_MESSAGE);
        }
    }//GEN-LAST:event_btnLuuActionPerformed

    private void txtLoaiHinhMoiKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtLoaiHinhMoiKeyReleased
        validateField();
    }//GEN-LAST:event_txtLoaiHinhMoiKeyReleased
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        while(itr.hasNext()){
            ...
            dtm.addRow(new Object[]{
                categoryObject.getId(),categoryObject.getTenLoaiHinh()
            });
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        JLabel label = new JLabel("Bạn có thực sự muốn xóa "+name+" ra khỏi Menu?");
        label.setFont(new Font("Arial", Font.BOLD, 14));
    ...
    private javax.swing.JTextField txtLoaiHinhMoi;
